# <a name="typescripting-visual-studio-excel-javascript-add-in-template"></a>Conversão em TypeScript do modelo de suplemento em JavaScript para Excel do Visual Studio
